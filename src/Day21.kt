...
private fun getShortestKeypadPath(start: KeypadKey, end: KeypadKey): List<DirectionPadKey> =
    when (start to end) {
        ...
        KeypadKey.A to KeypadKey.FIVE -> listOf(
            DirectionPadKey.LEFT,
            DirectionPadKey.UP,
            DirectionPadKey.UP,
            DirectionPadKey.A
        ...
        KeypadKey.ZERO to KeypadKey.FIVE -> listOf(
            DirectionPadKey.UP,
            DirectionPadKey.UP,
            DirectionPadKey.A
        )

        KeypadKey.ZERO to KeypadKey.EIGHT -> listOf(
            DirectionPadKey.UP,
            DirectionPadKey.UP,
            DirectionPadKey.UP,
            DirectionPadKey.A
        ...
        KeypadKey.ONE to KeypadKey.SEVEN -> listOf(
            DirectionPadKey.UP,
            DirectionPadKey.UP,
            DirectionPadKey.A
        )

        KeypadKey.ONE to KeypadKey.EIGHT -> listOf(
            DirectionPadKey.UP,
            DirectionPadKey.UP,
            DirectionPadKey.RIGHT,
            DirectionPadKey.A
        ...
        KeypadKey.FOUR to KeypadKey.SIX -> listOf(
            DirectionPadKey.RIGHT,
            DirectionPadKey.RIGHT,
            DirectionPadKey.A
        )
        ...
        KeypadKey.FIVE to KeypadKey.ZERO -> listOf(
        ...
        KeypadKey.FIVE to KeypadKey.NINE -> listOf(
            DirectionPadKey.UP,
            DirectionPadKey.RIGHT,
            DirectionPadKey.A
        )
        ...
        KeypadKey.SIX to KeypadKey.THREE -> listOf(
            DirectionPadKey.DOWN,
            DirectionPadKey.A
        )
        ...
        KeypadKey.EIGHT to KeypadKey.A -> listOf(
            DirectionPadKey.DOWN,
            DirectionPadKey.DOWN,
            DirectionPadKey.DOWN,
            DirectionPadKey.RIGHT,
        ...
        KeypadKey.EIGHT to KeypadKey.SEVEN -> listOf(DirectionPadKey.LEFT, DirectionPadKey.A)
...
private fun getShortestDirectionPadPath(start: DirectionPadKey, end: DirectionPadKey) =
    when (start to end) {
...
fun getComplexity(input: String, times: Int): Long {
...
fun main() {
    fun part1(input: List<String>): Long {
        return input.sumOf { code -> getComplexity(code, 2) }
    }

    fun part2(input: List<String>): Long {
        return input.sumOf { code -> getComplexity(code, 25) }
    }
