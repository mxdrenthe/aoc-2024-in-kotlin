...
private fun getAllShortestPathLengths(start: Position, end: Position, targetScore: Long, map: Map): Long {
    ...
    return validPositions.count().toLong()
}

private fun getMap(input: List<String>): Map = input
...
fun main() {
    ...
    fun part2(input: List<String>): Long {
        ...
        return getAllShortestPathLengths(start, end, smallestScore, map)
    }
