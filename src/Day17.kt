...
fun main() {
    fun part1(input: String): String {
        val (inputRegister, inputInstructions) = input.split("\r\n\r\n")
        val registers = parseRegisters(inputRegister)
    ...
    fun part2(input: String): String {
        ...
        val registers = parseRegisters(inputRegister)
        val instructions = parseInstructions(inputInstructions)
        val reversedProgram = getReversedProgram(inputInstructions)
        val state = State(registers, instructions)
    ...
    val testInput = readAllInput("Day17_test")
    check(part1(testInput) == "4,6,3,5,6,3,5,2,1,0")

    val input = readAllInput("Day17")
    part1(input).println()
    part2(input).println()
}
